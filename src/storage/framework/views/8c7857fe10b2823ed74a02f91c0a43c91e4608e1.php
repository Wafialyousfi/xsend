...
<head>
    ...
    <meta name="bee-client-id" content="<?php echo e(@json_decode($general->bee_plugin,true)['client_id']); ?>">
    <meta name="bee-client-secret" content="<?php echo e(@json_decode($general->bee_plugin,true)['client_secret']); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/global/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/global/css/line-awesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/global/css/font_bootstrap-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/global/css/plugin.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/global/css/toastr.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/css/select2.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/css/apexcharts.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/css/datepicker/datepicker.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/css/simplebar.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/css/responsive.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/css/summernote-lite.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme/admin/flag-icons/flag-icons.css')); ?>">
...
<body>
    ...
    <script src="<?php echo e(asset('assets/theme/global/js/whatsapp.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/global/js/toastr.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/apexcharts.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/ckd.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/simplebar.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/datepicker/datepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/datepicker/datepicker.en.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/script.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme/admin/js/summernote-lite.min.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        function changeLang(val){
            window.location.href = "<?php echo e(route('home')); ?>/language/change/"+val;
        }
        $(".active").focus();
...
<?php /**PATH C:\xampp\htdocs\xsender\src\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>